...
<head>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Order creation <small>Select start city and truck for order</small>
            </h1>
        </section>
            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="box">
                        ...
                        <form role="form" action="${pageContext.request.contextPath}/manager/orders/createStart" method="get">
                            <div class="box-body">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <c:forEach var="truck" items="${truckList}">
                                    <tr>
                                        ...
                                        <td>
                                            <form action="${pageContext.request.contextPath}/manager/orders/create" method="post">
