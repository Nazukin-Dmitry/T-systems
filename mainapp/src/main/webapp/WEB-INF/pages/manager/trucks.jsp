            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="box">
                        ...
                        <form role="form" action="${pageContext.request.contextPath}/manager/trucks" method="get">
                            <div class="box-body">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <c:forEach var="truck" items="${truckList}">
                                    <tr>
                                        ...
                                        <td><a href="${pageContext.request.contextPath}/manager/trucks/edit?id=${truck.id}">edit</a></td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                            </table>
