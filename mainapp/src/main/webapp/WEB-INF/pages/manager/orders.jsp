            ...
            <div class="row">
                <div class="col-md-2">
                    <div class="box">
                        ...
                        <form role="form" action="${pageContext.request.contextPath}/manager/orders" method="get">
                            <div class="box-body">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <c:forEach var="order" items="${orderList}">
                                    <tr>
                                        ...
                                        <td>${order.status}</td>
                                        <td><a href="${pageContext.request.contextPath}/manager/orders/cargos?orderId=${order.id}">info</a></td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                            </table>
